create or replace procedure finance_db.dev_netsuite.sp_arr_master_new()
    returns varchar
    language sql
    execute as owner
as
...
begin
    ...
    ***********************************************************************/
    ...
    return 'Successfully created or replaced table finance_db.dev_netsuite.sp_arr_master_new.';
