create or replace view finance_db.dev_netsuite.vw_master_billing_new copy grants
...
Updated 08/10/2026 [Dan Girard] Repointed to finance_db.dev_netsuite.master_billing_new; product_group renamed to
                                productgroup; removed entity (not present in master_billing_new)
'
as
...
(
    select distinct
        ...
        mb.stream_reporting,
    from
        finance_db.dev_netsuite.master_billing_new mb
...
(
    select
        ...
        -- 08/10/2026 [Dan Girard] entity omitted -- not present in master_billing_new
